\chapter{Non-Resonant 7 TeV Analysis}
\label{ch:7tev}
...
\section{Electron Identification and Selection}
	...
	\hline\hline  \\ %[0.2ex] %inserting double-line
	\end{tabular}
	\caption{Data yield compared to background MC scaled to luminosity of data. Errors shown are statistical only.} %title of the table
...
%(analysis method)
	...
	\hline\hline  \\ %[0.2ex] %inserting double-line
	\end{tabular}
	\caption{CI signal yields for 4.9 $fb^{-1}$.} %title of the table
	\label{tab:CIyeilds}
	\end{table}
	...
	\hline\hline  \\ %[0.2ex] %inserting double-line
	\end{tabular}
	\caption{ADD analysis region yields for 4.9 $fb^{-1}$.} %title of the table
	\label{tab:ADDyeilds}
	\end{table}
	...
	\hline\hline  \\ %[0.2ex] %inserting double-line
	\end{tabular}
	\caption{Data and MC yields for ADD analysis region.} %title of the table
...
\section{Statistical Analysis}
	...
	\hline\hline  \\ %[0.2ex] %inserting double-line
	\end{tabular}
	\caption{95\% confidence level limits found in the CI and ADD analyses.} %title of the table
	\label{tab:Limits7}
	\end{table}

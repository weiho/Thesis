...
\begin{itemize}
\item Each electron is required to have a transverse momentum ($p_{T}$) greater than 30 GeV.
...
\item Same sign requirement. Require both electrons to be identified with the same sign.
\end{itemize}

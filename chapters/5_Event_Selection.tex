...
\section{Selection Acceptance $\times$ Efficiency}
   ...
   \begin {table}[h]
      ...
      \begin{tabular}{ | l | c | c | c | } 
         ...
         \hline
      \end{tabular}
      \caption{Table showing the efficiency each event selection on DY MC.}
      \label{tab:eventEff}
      \end{center}
   \end {table}

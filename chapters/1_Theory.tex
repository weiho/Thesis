...
\section{Standard Model}
    ...
    \begin{figure}[h]
        \begin{center}
        \includegraphics[width=0.3\linewidth]{images/Z_fermion.eps}
        \includegraphics[width=0.3\linewidth]{images/W_lepton.eps}
        \includegraphics[width=0.3\linewidth]{images/W_quark.eps}\\
        \includegraphics[width=0.3\linewidth]{images/Z_WW.eps}
        \includegraphics[width=0.24\linewidth]{images/ZZ_WW.eps}
        \includegraphics[width=0.24\linewidth]{images/WW_WW.eps}\\
        \end{center}

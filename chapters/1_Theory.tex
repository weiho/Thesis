...
\section{Standard Model}
    ...
    The Standard Model of particle physics is is a quantum field theory describing the interaction of particles and forces at a fundamental level. These forces and particles are so far seen to be the most fundamental components in nature describing all knows quantum systems but with the absence of gravity. Particles are split between fermions the particles composing matter and bosons the force carriers in the model. The bosons are split between the three fundamental forces Strong, Weak and Electromagnetic while the fermions are split in to two different categories leptons and quarks according to which forces they interact with. Fermions have the property of having spin 1/2 while bosons however have an integer spin of either 0 or 1. Each particle has an associated anti-particle with opposite charge and weak isospin. 
    ...
    \begin {table}[h]
      ...
      \begin{tabular}{|l|c|c|}
         ...
         \hline
      \end{tabular}
      \caption{Table showing the gauge bosons found in the standard model.}
      \label{tab:bosons}
      \end{center}
    \end {table}
    ...
    \begin{equation}
      ...
      \label{eq:Zboson}
    \end{equation}
    However electroweak unification alone causes a problem by predicting W and Z bosons as massless contradicting experimental results a implying electroweak symmetry must be broken. The solution to this problem comes about by the introduction of the Higgs mechanism. The Higgs mechanism makes the prediction of a new complex doublet of scalar fields refereed to as the Higgs field. This Higgs field has a none zero vacuum expectation value allowing symmetry in the electroweak force at high energies however at low energies the Higgs potential has to choose a state bellow the none zero vacuum expectations value inducing a spontaneous symmetry breaking and allowing the weak gauge bosons to have mass while photons remain massless. This Higgs field also gives rise to a massive scalar boson referred to as the Higgs boson. A scalar boson fitting the description of the Higgs boson was recently discovered at the two main LHC experiments proving the existence of electroweak symmetry breaking of this form exists \cite{Aad20121,Chatrchyan201230}. 


    \subsubsection*{Quantum Chromodynamics}
    
    Quantum Chromodynamics (QCD) is the theory associated with the strong force. It describes a interactions between particles conserving a quantum number called colour. The SU(3) symmetric group gives rise to 8 massless gauge bosons referred to as gluons. Gluons interact with only coloured particle which include quarks and themselves. The strong interaction is different in the way it strengthens with increasing distance and weakens to asymptotic freedom at small distances. This increases in interaction strength with increasing distance is referred to colour confinement discussed previously where as quarks separate interaction energy increases to the point that $q\bar{q}$ pairs form again forming colourless baryons and mesons. 
...
\section{Non-resonant new Physics}
    ...
    \subsection{Contact Interaction Theory}
        ...
        \begin{figure}[h]
            \begin{center}
            \includegraphics[width=0.95\linewidth]{images/compositeness.eps}
            \end{center}
    ...
    \subsection{ADD Theory}
        ...
        \begin{equation}
            ...
            \label{eq:gravScale}
        \end{equation}
        where $\Gamma$ is the decay width. Below the scale M$_{S}$ virtual Graviton exchange would lead to a broad excess over the SM Drell-Yan dilepton mass spectrum. 
        ...
        It is important to note the differences between this and the Randall Sundrum \cite{PhysRevLett.83.3370} Graviton model which predicts a Graviton signal as a peak structure at a single mass point due to the lack of KK towers in the theory.

        Experimentally this interaction would be seen as a deviation from the SM DY ($q\bar{q}~\rightarrow~\gamma/Z~\rightarrow~\ell^{-}\ell^{+}$) dilepton mass spectrum but with a cut-off where quantum gravity is assumed take effect. This can be seen in Fig. \ref{fig:theoryInvMassADD}.

...
\section{Systematics}
    ...
    \begin {table}[h]
        ...
        \begin{tabular}{ | l | c c | } 
            ...
            \hline
        \end{tabular}
        \caption{All sources of systematic error and their approximate as a percentage (\%) size for dielectron mass of 1 TeV (2 TeV) [3 TeV].}
        \label{tab:sys}
        \end{center}
    \end {table}
...
\subsection{Optimisation of Search Bins in $\cos{\theta^{*}}$}
    ...
    \begin {table}[h!]
        ...
        \begin{tabular}{ |l|c|c|c|c|c|c| } 
            ...
            \hline
        \end{tabular}
        \caption{Expected Limits calculated with 600 PE's for individual mass bins varying $\cos{\theta^{*}}$ binning to select variable search bins. The highest limits found for each invariant mass bin are shown in {\bf bold}. No systematics were included in this study.}
...
\section{Setting Limits}
    ...
    \begin {table}[h]
        ...
        \begin{tabular}{  l | c | c | c | c  } 
            ...
            \hline
        \end{tabular}
        \caption{Expected and observed limits for all CI formalisms and prior's.}
        \label{tab:limits_CI}
        \end{center}
    \end {table}
    ...
    \begin {table}[h]
        ...
        \begin{tabular}{ l | c | c } 
            ...
            \hline
        \end{tabular}
        \caption{Expected and observed limits for ADD with each prior.}

...
\section{Results}
	...
	\begin {table}[h]
		...
		\begin{tabular}{  l | c c c | c c c  } 
			...
			\hline
		\end{tabular}
	  	\caption{Table comparing background prediction to data with prediction of several CI signal models. Binning used is the same as used for statistical analysis of CI sample. Both combined statistical and total systematic error is included on each value. See section \ref{sec:sys} for details of systematics.}
	...
	\begin {table}[h]
		...
		\begin{tabular}{  l | c } 
	  	...
	  	\caption{Table comparing background prediction to data with prediction of several ADD signal models. One bin used the same in the statistical analysis of ADD. Both combined statistical and total systematic error is included on each value. See section \ref{sec:sys} for details of systematics.}
	  	\end{center}
	\end {table}

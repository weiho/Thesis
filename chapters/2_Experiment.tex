...
\section{The Large Hadron Collider}
	...
	The LHC cannot run in isolation to provide beams for its 4 main experiments, instead it is the last and newest accelerator in a chain of accelerators which extract protons from a hydrogen canister with little to no momentum and inject them in to the LHC as a 450~GeV beam.
...
\section{ATLAS - A Toroidal LHC Apparatus}
	...
	\begin{figure}[h]
		\begin{center}
			\includegraphics[width=0.98\linewidth]{images/ATLAS_SE_Corrected7.eps}
		\end{center}
	...
	\subsection{Inner Detector}
		...
		\begin{figure}[h!]
			\begin{center}
				\includegraphics[width=0.95\linewidth]{images/ID_newTRT_d3.eps}
			\end{center}
	...
	\subsection{Calorimeters}
		...
		\begin{figure}[h!]
			\begin{center}
				\includegraphics[width=0.95\linewidth]{images/ITCconcept_new.eps}
			\end{center}
	...
	\subsection{Magnet System}
		...
		\begin{figure}[h!]
			\begin{center}
				...
				\includegraphics[width=0.8\linewidth]{images/desc6.eps}
			\end{center}
